...
public:
    ...
    void saveChar(int cur_path[], int depth)
    {
    ...
    */
    ...
    void DFS(int head, int cur, int depth, int cur_path[]){
        visited[cur] = true;
...
int main()
{
    ...
    end3 = clock();
    cout<<"Time of write: "<<(double)(end3 - end2) / CLOCKS_PER_SEC<<"s"<<endl;
    return 0;
}